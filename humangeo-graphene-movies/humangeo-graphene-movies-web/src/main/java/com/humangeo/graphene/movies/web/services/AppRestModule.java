package com.humangeo.graphene.movies.web.services;

import com.humangeo.graphene.movies.web.rest.DataSourceServerRSImpl;
import com.humangeo.graphene.movies.web.rest.EntityServerRSImpl;
import com.humangeo.graphene.movies.web.rest.ExportGraphRSImpl;
...
public class AppRestModule {
	...
	public static void provideSymbols(
		...
		// This disables the autoscanning of com.humangeo.graphene.movies.web.rest
	...
	public static void resteasyPackageManager(
		...
		configuration.add("com.humangeo.graphene.movies.web.rest.autobuild");
	}
